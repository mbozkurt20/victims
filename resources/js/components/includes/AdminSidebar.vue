<template>
    <nav class="sidebar min-h-screen" style="background: #e38d02">
            ...
            <ul id="menu" class="nav flex-column mb-2">
                <li class="nav-item">
                    <router-link to="/admin" class="nav-link">
                        ...
                        <span class="d-none d-sm-inline ps-2">Panel</span>
                    </router-link>
                </li>
                <li v-if="can('user-list')" class="nav-item ">
                    ...
                    <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                        <li v-if="can('permission-list')" class="nav-link  w-100">
                            <router-link :to="{ name: 'permissions.index' }" class="nav-lin px-0">
